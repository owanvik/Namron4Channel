# NAMRON 4-Channel ZigBee Switch Blueprint for Home Assistant v2.0.0
...
3. Velg "NAMRON 4 Channel ZigBee Switch v2.0.0"
...
- Rettede beskrivelser og forbedret dokumentasjon
- Semantic versioning
